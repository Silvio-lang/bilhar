...
function moverArrasto(e) {
    if (arrastando) {
        ...
        // Atualiza a força baseada na distância percorrida
...
// Evento do Slider de Força (Apenas calibra a posição e espessura da linha)
if (sliderForca) {
...
// Confirmação e Execução do Disparo (Gatilho Único e Seguro)
...
function atualizarFisica() {
    // Aplicação simples de velocidade e atrito
...
// Comunicação Socket.io e Limpeza do Banner de Treino
